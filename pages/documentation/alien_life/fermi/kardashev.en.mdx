...
<figcaption style={{ color: "rgb(156, 156, 156)", fontSize: "14px", marginTop: "2px" }}>A visualization of different types on the Kardashev Scale, visualized by Kurzgesagt. Source: <strong>[Kurzgesagt](https://www.youtube.com/watch?v=rhFK5_Nx9xY)</strong></figcaption>
</figure>
...
A Type 3 civilization is basically "just" a Type 2 civilization that managed to not only use their home system's star's entire energy but repeat that step on all stars in their home galaxy. Type 4-5 are superlatives of this: A Type 4 civilization is able to control and use the energy of more than one galaxy while a Type 5 civilization controls their entire supercluster of local galaxies. 
