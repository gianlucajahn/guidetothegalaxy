...
<strong>[beyondearth.gg](http://beyondearth.gg/)</strong> is a thought experiment through the future of human spacetravel: In accordance with scientific findings of recent years and under constant updating, we set the expectation on ourselves to offer the best and most understandable outlook into the near future of mankind.

<br />
<figure>
<Image src={require(".//../../resources/images/hero10.png")} alt="An abstract spaceship, leaving Earth in the far future" />
<figcaption style={{ color: "rgb(156, 156, 156)", fontSize: "14px", marginTop: "2px" }}>An abstract spaceship, leaving Earth in the far future. Source: <strong>[Melodysheep](https://www.youtube.com/watch?v=SUelbSa-OkA&t=26s)</strong></figcaption>
</figure>
