...
<figcaption style={{ color: "rgb(156, 156, 156)", fontSize: "14px", marginTop: "2px" }}>The International Space Station (ISS) in orbit around the Earth. Source: <strong>[RocketSTEM](https://www.rocketstem.org/international-space-station/)</strong></figcaption>
</figure>
...
<figcaption style={{ color: "rgb(156, 156, 156)", fontSize: "14px", marginTop: "2px" }}>"The Lunar Gateway near the moon". Source: <strong>[NASA](https://www.nasa.gov/gateway)</strong></figcaption>
</figure>
...
Now that we've gotten all the aerospace engineering core fundamentals down, let's jump to the point where we <strong>actually</strong> travel to another planet.
...
<AdditionalResources>
  <div>
    <span>1. </span><li>Additional info about NASA's Lunar Gateway can be found <a href="https://www.nasa.gov/gateway" target="_blank">on NASA's portal for it</a>.</li>
  </div>
</AdditionalResources>
