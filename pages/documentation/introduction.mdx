...
what makes space and spacetravel work. If you want to learn more about the background of this website, feel free to check out our [FAQ](https://www.google.com).

## This guide's structure
We will start with the most obvious first question when it comes to spacetravel, which is ["Why should we pursue it at all?"](https://www.google.com) and will follow the (eventual) future path humanity will
...
on which I have received very positive feedback in my earlier german releases (see ["Almost Everything Beyond"](https://www.docdroid.net/I85CJD1/almost-everything-beyond-pdf)) and which I will continue similarly. If this isn't for you, that's perfectly understandable.
...
ordered chronologically in a logical manner, meaning any technical terms on an hypothetical page numbered `x` is explained on one of the pages numbered `x - y` whereas y is any [natural number](https://en.wikipedia.org/wiki/Natural_number).
...
not yet have any form of newspage that bundles all of the news around it. I intend to do that. 

Stay tuned or [help me do it](https://github.com/gianlucajahn/guidetothegalaxy.git), if you like 👨‍🔬.
