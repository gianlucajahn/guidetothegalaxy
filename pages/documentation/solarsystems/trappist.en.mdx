...
If you are wondering why it isn't higher than the one from Trappist 1D, it's mostly because the mass is much lower than earth (just 69% of it, and no, this is not a joke) and we still lack information about the atmosphere of Trappist 1E, so it's Earth Similarity Index might increase once we get our hands on more detailed information about it.
