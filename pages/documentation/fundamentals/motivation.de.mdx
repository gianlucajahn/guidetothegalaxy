...
Ähnlich wie ich bereits im <strong>[FAQ](https://guidetothegalaxy.vercel.app/faq)</strong> erläutert habe, gibt es keine eine Tätigkeit, der man objektiver Betrachtung zufolge nachgehen sollte sondern eine Vielzahl an Optionen, deren Attraktivität sich nach der jeweiligen Zielsetzung richtet. Nun jedoch zu erklären, wieso wir der Raumfahrt, der Astrophysik und der Weltraumkolonisation nachgehen sollten, wird kein Einfaches. Solltest du den pseudo-psychologischen Betrachtungswinkel überspringen wollen, klicke gern auf den Link zur <strong>[pragmatischen Weltanschauung](https://guidetothegalaxy.vercel.app/de/documentation/fundamentals/motivation#pragmatische-weltanschauung)</strong>.
