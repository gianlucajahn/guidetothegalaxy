...
## Unsere Optionen
Unabhängig davon, <strong>wohin</strong> wir gehen, unser Hauptaugenmark wird auf <strong>bewohnbarem</strong> Lebensraum liegen. Klar, zu Beginn werden wir eher versuchen, Proben aus Gestein und Boden fremder Himmelskörper zu entnehmen, um diese auf der Erde zu untersuchen - ähnlich, wie wir es schon jetzt mit dem Mond und dem Mars tun.
