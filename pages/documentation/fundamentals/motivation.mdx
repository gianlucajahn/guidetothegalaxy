...
As you might have noticed, it's really not hard to reason <strong>for</strong> space exploration, so I'll go ahead and call it a day for now. I'm sure y'all got it by now.
